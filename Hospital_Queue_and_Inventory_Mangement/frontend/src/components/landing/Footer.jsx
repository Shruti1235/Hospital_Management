          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
            <div>
              <p>
                ...
                <a
                  href="#"
                  className="block text-2xl font-small text-gray-700 hover:opacity-75 sm:text-3xl dark:text-white"
                >
                  0123456789
                </a>
                <span className="text-medium tracking-wide text-gray-700  dark:text-gray-400">
                    centermedcure@gmail.com
                </span>
              </p>
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              <div>
                <p className="font-medium text-blue-900 dark:text-white">Services</p>
              ...
              <div>
                <p className="font-medium text-blue-900 dark:text-white">About Us</p>
          ...
          <div className="mt-12 border-t border-gray-100 pt-12 dark:border-gray-800">
            <div className="sm:flex sm:items-center sm:justify-between">
              ...
              <p className="mt-8 text-xs text-gray-500 sm:mt-0 dark:text-gray-400">
                &copy; 2025. MedcureCenter+. All rights reserved.
              </p>
            </div>
          </div>
        </div>
